...
public class CalendarActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Kurukshetra");
        ...
        adapter=new ListViewAdapter4mag(this, arrayList);
    ...
    private void Logout(){
        ...
        finish();
        startActivity(new Intent(CalendarActivity2.this, Login.class));
    }
